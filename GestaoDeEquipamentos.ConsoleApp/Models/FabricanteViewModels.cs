...
public class CadastrarEquipmentViewModel : FormularioEquipamentoViewModel
{
    public CadastrarEquipmentViewModel()
    {

    }

    public CadastrarEquipmentViewModel(List<Fabricante> fabricantes)
    {
